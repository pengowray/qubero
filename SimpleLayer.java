...
public class SimpleLayer {
    ...
    //XXX: allow relative layer depth. e.g. "this is higher than that, and that's higher than that.."
    
    //XXX: allow more complex bounds, eg. 2D areas. (3d areas? trees?)
    ...
    public void delete(int offset, int count);1
