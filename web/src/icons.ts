...
/** `icons/settings.svg`: a gear, for the toolbar button that opens settings. */
const SETTINGS_GEAR: readonly Shape[] = [
  [
    "path",
    {
...
export const gearIcon = (): SVGSVGElement => icon(SETTINGS_GEAR);
