 ...
 * @author  Smiley
 */
public class IntResourcePropertiesForm extends JFrame {
    ...
    public IntResourcePropertiesForm(IntResource intRes) {
        ...
        okay.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                IntResourcePropertiesForm.this.save();
                IntResourcePropertiesForm.this.close();
            }
        });
        buttons.add(okay);
        ...
        modListener = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                //IntResourcePropertiesForm.this.apply.setEnabled(true);
                //fixme: do anyhting else when modded? keep track?
                IntResourcePropertiesForm.this.mod();
            }
        };
        
        menu = new PropertyPage[] {
        ...
        nav.addTreeSelectionListener(new TreeSelectionListener() {
            public void valueChanged(TreeSelectionEvent treeEvent) {
                ...
                if (userObj == null) {
                    ...
                    IntResourcePropertiesForm.this.setPage((PropertyPage)userObj);
                } else {
