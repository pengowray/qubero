 ...
 *
 * XXX: Must all be rewritten. this class doesn't really work for longs properly because the
...
public class DefaultLongListSelectionModel implements LongListSelectionModel, Serializable
{
	...
	return ((index < minIndex) || (index > maxIndex)) ? false : value.get((int)(index)); //xxx!!
    }
