...
import net.pengo.dependency.DepLink;
import net.pengo.dependency.InfoLink;
...
public class IntAddressedResource extends IntResource implements AddressedResource {
    private SmartPointer signedResP = new JavaPointer(getOpenFile(), "net.pengo.resource.IntResource"); //private IntResource signedRes;
    private SmartPointer selResP = new JavaPointer(getOpenFile(), "net.pengo.resource.SelectionResource"); //private SelectionResource selRes;
    private SmartPointer allowResizeP  = new JavaPointer(getOpenFile(), "net.pengo.resource.BooleanResource");
	...
	setAllowResize(new BooleanPrimativeResource(getOpenFile(), false));
	...
	setSignedRes( new IntPrimativeResource(openFile, signage) );
    }
	...
	byte[] b = encodeBigInt(value);
        ...
        LongListSelectionModel sel = getSelectionResource().getSelection();
