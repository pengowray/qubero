...
public class AsciiRenderer extends SeperatorRenderer {
	...
	this(fm, columnCount, render, true);
    }

    public AsciiRenderer(FontMetrics fm, int columnCount, boolean render, boolean hideHighAscii) {
        super(fm, columnCount, render);
	this.hideHighAscii = hideHighAscii;
    }
