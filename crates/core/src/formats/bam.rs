...
use super::bam_index::{csi_stream, CSI_MAGIC};
...
pub(crate) mod tests {
    ...
    use crate::formats::bam_index::tests::csi_stream_bytes;
    ...
    pub(in crate::formats) fn at_named(ev: &mut Evaluator, d: &Document<MemSource>, path: &[usize], names: &[&str]) -> Vec<usize> {
    ...
    pub(in crate::formats) fn joined(ev: &mut Evaluator, d: &Document<MemSource>) -> Vec<usize> {
