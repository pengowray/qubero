...
const SWEEP_TYPE: &[(i128, &str)] = &[(1, "linear"), (2, "parabolic"), (3, "exponential"), (4, "other")];

const TAPER_TYPE: &[(i128, &str)] = &[(1, "linear"), (2, "cosine squared"), (3, "other")];

/// Correlated or not, which the standard writes as 1 for no and 2 for yes.
const NO_YES: &[(i128, &str)] = &[(1, "no"), (2, "yes")];

/// And binary gain recovered, which it writes the other way round.
const YES_NO: &[(i128, &str)] = &[(1, "yes"), (2, "no")];

const AMPLITUDE_RECOVERY: &[(i128, &str)] = &[(1, "none"), (2, "spherical divergence"), (3, "AGC"), (4, "other")];

const MEASUREMENT_SYSTEM: &[(i128, &str)] = &[(1, "metres"), (2, "feet")];
...
/// 45-degree sectors.
const VIBRATORY_POLARITY: &[(i128, &str)] = &[
...
/// 2's addition.
const TIME_BASIS: &[(i128, &str)] = &[(1, "local"), (2, "GMT"), (3, "other"), (4, "UTC"), (5, "GPS")];

/// What a trace is a recording of. Values from 22 up are for whoever writes
/// the file to assign.
const TRACE_ID: &[(i128, &str)] = &[
    (-1, "other"),
    (0, "unknown"),
    (1, "seismic data"),
    (2, "dead"),
...
const OVER_TRAVEL: &[(i128, &str)] = &[(1, "down or behind"), (2, "up or ahead")];
