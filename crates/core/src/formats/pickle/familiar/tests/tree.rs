...
fn an_empty_array_reads_its_numbers_where_they_would_have_been() {
    ...
    let seen = dump(&bytes);
    assert_eq!(named_row(&seen, "form").value, V::Str("numpy-array-p4-p5-v7".into()));
...
/// The same row for the values that are not one thing and not a count either:
/// an array says what it holds and how much of it, an object says what class
/// it is, and a name says what it names and where the file wrote it.
#[test]
fn an_entry_reads_as_the_array_the_object_and_the_name_it_holds() {
    // The venv's Python, protocol 4:
    // pickle.dumps({"arr": numpy.arange(20, dtype="float64").reshape(10, 2),
    //               "shared": shared, "again": shared, "est": StandardScaler()}, 4)
    let bytes = b"";
    let seen = dump(bytes);
    for (name, says) in [
        // NumPy's own word for the type, which is what the table's column
        // header says too, rather than the letters `<f8`.
        ("arr", "float64 array 10 x 2"),
        ("shared", "list of 3"),
        // A name is two bytes that say nothing on their own, so the row says
        // what is at the other end and where the file wrote it.
        ("again", "list at 0x147"),
        // An object reads as its class, so a tree of them reads without a
        // fold being opened.
        ("est", "sklearn.preprocessing._data.StandardScaler"),
    ] {
